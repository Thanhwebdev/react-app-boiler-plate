export default {
  configFields: {
    description:
      "Enter your Beebox project credentials. You can obtain these from the Beebox dashboard settings page. <br /> Verify the connection. Hit <strong>Save</strong>, then, <strong>Open Stack</strong>.",
    beeboxSettings: {
